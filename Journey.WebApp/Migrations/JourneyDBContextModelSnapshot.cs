...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Journey.WebApp.Data.AlbumPhoto", b =>
                {
            ...
            modelBuilder.Entity("Journey.WebApp.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Journey.WebApp.Data.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.Traveler", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelerAlbum", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelerPhoto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelerRelationships", b =>
                {
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelersCities", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelersTrips", b =>
                {
                    b.Property<long>("TripId")
                        .HasColumnName("TripID");
            ...
            modelBuilder.Entity("Journey.WebApp.Data.Trip", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TripActivities", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TripCities", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TripDetails", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.AlbumPhoto", b =>
                {
                    b.HasOne("Journey.WebApp.Data.TravelerAlbum", "Album")
                        .WithMany("AlbumPhoto")
                        .HasForeignKey("AlbumId")
                        .HasConstraintName("FK__AlbumPhot__Album__14270015");

                    b.HasOne("Journey.WebApp.Data.TravelerPhoto", "Photo")
                        .WithMany("AlbumPhoto")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.ApplicationUser", b =>
                {
                    b.HasOne("Journey.WebApp.Data.Traveler", "Traveler")
                        .WithMany()
            ...
            modelBuilder.Entity("Journey.WebApp.Data.Traveler", b =>
                {
                    b.HasOne("Journey.WebApp.Data.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Journey.WebApp.Data.Traveler", "UserId")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelerAlbum", b =>
                {
                    ...
                    b.HasOne("Journey.WebApp.Data.Trip", "Trip")
                        .WithMany("TravelerAlbum")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelerRelationships", b =>
                {
                    b.HasOne("Journey.WebApp.Data.Traveler", "TravelerId1Navigation")
                    ...
                    b.HasOne("Journey.WebApp.Data.Traveler", "TravelerId2Navigation")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TravelersCities", b =>
                {
                    b.HasOne("Journey.WebApp.Data.City", "City")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TripActivities", b =>
                {
                    b.HasOne("Journey.WebApp.Data.TripDetails", "TripDetails")
            ...
            modelBuilder.Entity("Journey.WebApp.Data.TripDetails", b =>
                {
                    b.HasOne("Journey.WebApp.Data.TripCities", "TripCities")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Journey.WebApp.Data.ApplicationUser")
                        .WithMany()
